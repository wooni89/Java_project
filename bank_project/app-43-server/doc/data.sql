...
insert into myapp_account(account_no, name, account_number, password, bank_name, balance) 
  values(1, '손흥민', '10001234',sha1('1111'), '신한은행', 20000000);
insert into myapp_account(account_no, name, account_number, password, bank_name, balance) 
  values(2, '이강인', '20001234',sha1('1111'), '국민은행', 3000000);
insert into myapp_account(account_no, name, account_number, password, bank_name, balance) 
  values(3, '조규성', '50001234',sha1('1111'), '농협은행', 5000000);
insert into myapp_account(account_no, name, account_number, password, bank_name, balance) 
  values(4, '김민재', '30001111',sha1('1111'), '하나은행', 20000000);
insert into myapp_account(account_no, name, account_number, password, bank_name, balance) 
  values(5, '황의조', '10001212',sha1('1111'), '신한은행', 30000);
insert into myapp_account(account_no, name, account_number, password, bank_name, balance) 
