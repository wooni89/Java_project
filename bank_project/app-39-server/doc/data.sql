...
insert into myapp_board(board_no, title, content, writer, password)
  values (11, '제목1', '내용1', '1', sha1('1111'));
insert into myapp_board(board_no, title, content, writer, password)
  values (12, '제목2', '내용2', '1', sha1('1111'));
insert into myapp_board(board_no, title, content, writer, password)
  values (13, '제목3', '내용3', '1', sha1('1111'));
insert into myapp_board(board_no, title, content, writer, password)
  values (14, '제목4', '내용4', '2', sha1('1111'));
insert into myapp_board(board_no, title, content, writer, password)
  values (15, '제목5', '내용5', '2', sha1('1111'));
insert into myapp_board(board_no, title, content, writer, password)
  values (16, '제목6', '내용6', '3', sha1('1111'));