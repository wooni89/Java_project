...
<c:set var="customer" value="${customerDao.findBy(param.no)}"/>
...
<c:if test="${not empty customer}">
    <form action='/customer/update.jsp' method='post' enctype='multipart/form-data'>
        <table border='1'>
            <tr>
        ...
        <div>
            ...
            <a href='/customer/delete.jsp?no=${customer.no}'>삭제</a>
            <a href='/customer/list.jsp'>목록</a>
        </div>
    </form>
</c:if>
